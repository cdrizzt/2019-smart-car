...
#define NRF_DATA_WIDTH  10                  // RF数据宽度 1~32byte


//-------宏定义引脚--------
#define NRF_CE_PIN          D12
#define NRF_CSN_PIN         D14
#define NRF_MOSI_PIN        D11
#define NRF_SCK_PIN         D9
                            
#define NRF_MISO_PIN        D5
...
extern uint8 NRF_RF_Addr[NRF_ADDR_WIDTH];   // TX,RX地址,可自行更改
// 用户函数
